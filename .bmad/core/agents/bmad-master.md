...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="*six-hats" workflow="{project-root}/.bmad/core/workflows/six-hats/workflow.yaml">Multi-perspective analysis using Six Thinking Hats method</item>
    <item cmd="*first-principles" workflow="{project-root}/.bmad/core/workflows/first-principles/workflow.yaml">Challenge assumptions and rebuild from fundamental truths</item>
